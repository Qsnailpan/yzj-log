...
import com.tfb.log.common.constant.PropertiesConstants;
import com.tfb.log.common.model.NormalEvent;
import com.tfb.log.common.schemas.NormalEventSchema;
...
import static com.tfb.log.common.constant.PropertiesConstants.*;
...
public class KafkaConfigUtil {
    ...
    public static DataStreamSource<NormalEvent> buildSource(StreamExecutionEnvironment env) throws IllegalAccessException {
     ...
     */
    public static DataStreamSource<NormalEvent> buildSource(StreamExecutionEnvironment env, String topic, Long time) throws IllegalAccessException {
        ParameterTool parameterTool = (ParameterTool) env.getConfig().getGlobalJobParameters();
        Properties props = buildKafkaProps(parameterTool);


        FlinkKafkaConsumer011<NormalEvent> consumer = new FlinkKafkaConsumer011<>(topic, new NormalEventSchema(), props);
