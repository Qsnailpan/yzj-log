...
public class DateUtil {
    ...
    public static DateTimeFormatter YYYY_MM_DD_T_HH_MM_SS_000Z = DateTimeFormat.forPattern("yyyy-MM-dd'T'HH:mm:ss.SSSZ");


    public static void main(String[] args) throws ParseException {
        String date = "2021-08-25T02:16:35.285Z";
...
//        System.out.println(dateTimeFormatter.parseMillis(date));
    ...
    public static long format(String date) throws ParseException {
        date = date.replace("Z", " UTC");
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS Z");
    ...
    public static long format(String time, DateTimeFormatter dateFormatter) {
        if (YYYY_MM_DD_T_HH_MM_SS_000Z.equals(dateFormatter)) {
            return YYYY_MM_DD_T_HH_MM_SS_000Z.parseMillis(time);
        } else if (YYYY_MM_DD_HH_MM_SS_0.equals(dateFormatter)) {
